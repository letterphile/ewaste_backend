# Generated by Django 2.1.7 on 2019-03-02 18:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('SELLER', 'Seller'), ('BUYER', 'Buyer'), ('ADMIN', 'Admin')], default='BUYER', max_length=50)),
        ...
        migrations.AddField(
            model_name='device',
            name='manufacturer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.Manufacturer'),
        ),
        migrations.AddField(
            model_name='device',
            name='sellers',
